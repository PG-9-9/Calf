...
def plot_detection_scores(input_dir, model_dir, pipeline_file, filename, image_save_dir, start_index, end_index, event_name, day):
    ...
    scores_filename = os.path.join(image_save_dir, f'{day}_confidence_scores.txt')
...
input_img_dir = "/home/woody/iwso/iwso122h/Calf_Detection/new_img_data/images_test/2023-12-11"
...
filename="11_dec_detection_score_e10.png"
day="11_Dec"
start_index = 394  
end_index = 414   
