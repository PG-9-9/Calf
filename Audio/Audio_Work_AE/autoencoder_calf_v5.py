...
def hyperparameter_tuning(root_path, data_path, config_list):
    for config in config_list:
        ...
        normal_audio_windows, _ = load_and_window_audio_files(data_path['normal'], label=0, window_size=window_size, step_size=step_size, sample_rate=sample_rate)
        abnormal_audio_windows, _ = load_and_window_audio_files(data_path['abnormal'], label=1, window_size=window_size, step_size=step_size, sample_rate=sample_rate)
